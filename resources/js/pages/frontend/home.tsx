...
const slides = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1768489038182-7db6980fd841?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    tagline: 'Premium Quality',
    title: 'Comfort Meets Fashion',
    image: 'https://images.unsplash.com/photo-1767172352170-19b1140dc51f?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    tagline: 'Exclusive Designs',
    title: 'Stand Out From The Crowd',
    image: 'https://images.unsplash.com/photo-1767431199061-3237ddd5de9f?q=80&w=1210&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
];
            ...
            <div className="bg-[#FDF7F7] font-sans text-gray-900 overflow-x-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="overflow-hidden rounded-md aspect-[4/5] bg-gray-200">
                        <img
                        src="https://images.unsplash.com/photo-1768489038182-7db6980fd841?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <div className="grid grid-cols-2 gap-8">
                    ...
                    <div
                        ...
                        style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1768489038182-7db6980fd841?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")' }}
                    >
